...
Les règles "objets" servent à viser un réseau ou un appareil spécifique et lui donner des règles simples, prioritaires par rapports aux autres règles. Le contrôle que l'on peut avoir sur la configuration est assez limité ici, donc je ne l'utilise que pour des règles simples.
